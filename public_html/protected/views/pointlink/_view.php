...
<div class="panel panel-default">
	...
	<?php echo CHtml::encode($data->getAttributeLabel('id')); ?>:<?php echo CHtml::link(CHtml::encode($data->id), array('view', 'id'=>$data->id)); ?><?php echo CHtml::link(CHtml::encode(''), array('update', 'id'=>$data->id),array('class'=>'fa fa-pencil fa-fw pull-right',
						...
						'data-toggle'=>'tooltip',
		            	'data-placement'=>'top',
		            	'data-original-title'=>'View')); ?></div><div class="panel-body">	<b><?php echo CHtml::encode($data->getAttributeLabel('Streetview_id')); ?>:</b>
	<?php echo CHtml::encode($data->Streetview_id); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('pano_LinkID')); ?>:</b>
	<?php echo CHtml::encode($data->pano_LinkID); ?>
	<br />
