<div class="container">
  <div class="row">
    <div class="col-sm-3">
      ...
      <div class="user-menu">
        <ul>
          <li><?php echo CHtml::link('<i class="sign fa fa-user bg-green"></i>'.Yii::t('app','My Profile').'<i class="fa fa-chevron-right pull-right"></i>',array('users/profile'),array('class'=>'active')); ?></li>
    ...
    <div class="col-sm-9">
        ...
        <div class="col-sm-12">
          <hr class="arrow-down">
          <h4 class="primary-font"></h4>
        </div>
        
        <div class="col-sm-12">
        <div class="shopping-cart user-cart">
