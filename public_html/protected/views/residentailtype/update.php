...
$this->menu=array(
	...
	array('label'=>'View Residentailtype', 'url'=>array('view', 'id'=>$model->id)),
...
<h2 class="headline first-child text-color"><span class="border-color">Update Residentailtype <?php echo $model->id; ?></span></h2>
