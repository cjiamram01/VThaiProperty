...
$('.search-form form').submit(function(){
	$('#residentailtype-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<h2 class="headline first-child text-color"><span class="border-color">Manage Residentailtypes</span></h2>
