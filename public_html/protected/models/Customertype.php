 ...
 *
 * The followings are the available columns in table 'tbl_customertype':
 * @property integer $id
...
class Customertype extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('customertype', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, customertype', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			'id' => Yii::t('app','ID'),
			'customertype' => Yii::t('app','Customertype'),
		);
	}
