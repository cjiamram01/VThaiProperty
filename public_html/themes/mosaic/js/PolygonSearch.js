      ...
      function responseList(url)
      {
        ...
        //url="http://localhost/vthaiproperty/public_html/propertyList.php";
    ...
    function addMarker(location) {
      ...
      function showLocation(position) 
      {
        ...
        drawingManager = new google.maps.drawing.DrawingManager({
         ...
         //var url="http://localhost/vthaiproperty/public_html/propertyList.php";
         //responseList(url);
         ...
         function setCircleMarker(circle){
              ...
              if(result.length>0) 
              {
                ...
                url="http://localhost/vthaiproperty/public_html/propertyList.php?point="+result;
              }
              else
                url="http://localhost/vthaiproperty/public_html/propertyList.php";
